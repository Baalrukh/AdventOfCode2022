...
internal class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        File.WriteAllText(Path.Combine(solutionRoot, $"AdventOfCode2022/Input/day{day:00}.txt"), clipboard);

        CopyTemplate("ExerciseTemplate.txt", day, Path.Combine(solutionRoot, $"AdventOfCode2022/Day{day:00}.cs"));
        CopyTemplate("TestTemplate.txt", day,
            Path.Combine(solutionRoot, $"AdventOfCode2022.Test/Day{day:00}Tests.cs"));
    ...
    {
        string csprojPath = Path.Combine(solutionRoot, "AdventOfCode2022/AdventOfCode2022.csproj");
